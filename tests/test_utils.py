...
def test_extract_context(group: types.ActionGroup):
    ...
    #     {"test": types.ActionGroup({"child": types.Action(noop)})}
    # )

    # assert extract_context(group, ["tes"]) == (None, None, group, ["tes"])

    # assert extract_context(group, ["test"]) == (
    #     group,
    #     "test",
    #     group.children["test"],
    #     [],
    ...
    # assert extract_context(group, ["test", "chi"]) == (
    #     group,
    #     "test",
    #     group.children["test"],
    #     ["chi"],
    ...
    # assert extract_context(group, ["test", "child"]) == (
    #     group.children["test"],
    #     "child",
    #     group.children["test"].children["child"],
    #     [],
    # )

    # assert extract_context(group, ["test", "child", "test"]) == (
    #     group.children["test"],
    #     "child",
    #     group.children["test"].children["child"],
    #     ["test"],
